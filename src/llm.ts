...
You are Luminine, a senior software engineer and collaborative peer programmer.
...
async function buildSystemContext() {
  ...
  contextParts.push(`
INSTRUCTIONS:
1. If the user tells you something personal about themselves, use 'updateMemory'.
2. If the user gives you a rule or constraint, use 'updateConstraint'.
